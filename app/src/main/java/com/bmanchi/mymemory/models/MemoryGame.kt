...
import com.bmanchi.mymemory.utils.DEFAULT_ICONS
...
class MemoryGame (private val boardSize: BoardSize) {
    ...
    fun flipCard(position: Int): Boolean {
        ...
        // 2 cards previously flipped over => restore cards + flip over the selected card (similar to first case)
        var foundMatch = false
        if (indexOfSingleSelectedCard == null) {
            // o or 2 cards previously flipped over
            restoreCards()
